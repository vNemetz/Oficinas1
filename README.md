ADL (Automatic Door Locker) is a door locker that can be unlocked by facial recognition or remote access (Wi-Fi connection).


The ADL is an alternative for the usual door lockers, being safer, unlocking only with the registered faces, and more efficient, noticing that it can be opened from far distances.
